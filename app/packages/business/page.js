    ...
    <div className="flex flex-col min-h-screen bg-gft-light overflow-x-hidden selection:bg-gft-primary selection:text-white">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-b from-gft-dark-bg via-[#082E2B] to-[#031412] text-white">
        <div className="max-w-4xl mx-auto px-6 text-center flex flex-col gap-4 relative z-10">
          <span className="text-gft-accent font-bold text-xs uppercase tracking-widest">Premium Tiers</span>
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight">Business Staking Packages</h1>
          <p className="text-white/75 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            Unleash structural corporate returns. High-end portfolios starting at ₹1,50,000 for serious leaders.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 max-w-7xl mx-auto px-6 w-full flex-1">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {businessPackages.map((pkg, idx) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 to-gft-primary/10 opacity-40 pointer-events-none" />

              <div className="relative z-10 flex flex-col gap-4">
                <div>
                  <span className="px-2.5 py-1 bg-amber-100 text-amber-800 text-[9px] font-bold uppercase rounded-full tracking-wider">Business Tier</span>
