...
const defaultPackages = [
  { name: "Student Lite", amount: 1200, activationDate: "2025-11-12", expiryDate: "2026-11-12", status: "Active" },
  { name: "Personal Star", amount: 20000, activationDate: "2026-02-15", expiryDate: "2027-02-15", status: "Active" }
];

const defaultStudentPackages = [
  { id: "student-1", name: "Student Lite", amount: 1200, roi: 5.0, monthlyReturn: 60, tokens: 180, duration: 12 },
  { id: "student-2", name: "Student Plus", amount: 3000, roi: 6.0, monthlyReturn: 180, tokens: 420, duration: 12 },
  { id: "student-3", name: "Student Pro", amount: 5000, roi: 7.0, monthlyReturn: 350, tokens: 650, duration: 12 },
  { id: "student-4", name: "Student Max", amount: 10000, roi: 8.0, monthlyReturn: 800, tokens: 1200, duration: 12 }
];

const defaultPersonalPackages = [
  { id: "personal-1", name: "Personal Star", amount: 20000, roi: 8.5, monthlyReturn: 1700, tokens: 2300, duration: 12 },
  { id: "personal-2", name: "Personal Bronze", amount: 30000, roi: 10.0, monthlyReturn: 3000, tokens: 3000, duration: 12 },
  { id: "personal-3", name: "Personal Silver", amount: 50000, roi: 11.5, monthlyReturn: 5740, tokens: 4250, duration: 12 },
  { id: "personal-4", name: "Personal Gold", amount: 100000, roi: 12.5, monthlyReturn: 12500, tokens: 7500, duration: 12 }
];

const defaultBusinessPackages = [
  { id: "business-1", name: "Business Elite", amount: 150000, roi: 13.0, monthlyReturn: 19500, tokens: 10500, duration: 12 },
  { id: "business-2", name: "Business Master", amount: 200000, roi: 13.5, monthlyReturn: 27000, tokens: 13000, duration: 12 },
  { id: "business-3", name: "Business Premium", amount: 300000, roi: 14.0, monthlyReturn: 42000, tokens: 18000, duration: 12 },
  { id: "business-4", name: "Business Executive", amount: 500000, roi: 15.0, monthlyReturn: 75000, tokens: 25000, duration: 12 }
];

const defaultRanks = [
  { id: "star", name: "GFT Star", turnover: 100000, matchedTurnover: 50000, fund: "Star Fund", travel: "Domestic Trip", rewards: "GFT Badge" },
  { id: "bronze", name: "Bronze", turnover: 200000, matchedTurnover: 100000, fund: "Bronze Fund", travel: "Local Getaway", rewards: "Premium Watch" },
  { id: "silver", name: "Silver", turnover: 250000, matchedTurnover: 125000, fund: "Silver Fund (2%)", travel: "State Seminar", rewards: "Smart Mobile / Pin", cashAlternative: "5,000" },
  { id: "gold", name: "Gold", turnover: 750000, matchedTurnover: 250000, fund: "Gold Fund (1.5%)", travel: "National Summit", rewards: "Fossil Hybrid Watch", cashAlternative: "11,250" },
  { id: "emerald", name: "Emerald", turnover: 1500000, matchedTurnover: 750000, fund: "Emerald Fund (1%)", travel: "Regional Retreat", rewards: "Emerald Ring / Gold Coin", cashAlternative: "15,000" },
  { id: "platinum", name: "Platinum", turnover: 3000000, matchedTurnover: 1500000, fund: "Platinum Fund (0.75%)", travel: "International Forum", rewards: "Yamaha R15 V4 Bike", cashAlternative: "22,500" },
  { id: "diamond", name: "Diamond", turnover: 6000000, matchedTurnover: 3000000, fund: "Diamond Fund (0.5%)", travel: "2 Person Cruise Trip", rewards: "GFT Diamond Trophy", cashAlternative: "30,000" },
  { id: "ruby", name: "Ruby", turnover: 12000000, matchedTurnover: 6000000, fund: "Ruby Fund (0.25%)", travel: "1 Week Thailand Trip", rewards: "Ruby Watch", cashAlternative: "30,000" },
  { id: "chairman", name: "Chairman", turnover: 25000000, matchedTurnover: 12000000, fund: "Chairman Fund (1%)", travel: "Dubai Trip (Requires 3 Rubies)", rewards: "Mercedes-Benz E-Class lease", cashAlternative: "2,50,000" }
];

const defaultPassiveIncome = [
  { level: 1, turnover: 500000, monthly: 2000, yearly: 24000 },
  { level: 2, turnover: 1000000, monthly: 5000, yearly: 60000 },
  { level: 3, turnover: 5000000, monthly: 25000, yearly: 300000 },
  { level: 4, turnover: 10000000, monthly: 50000, yearly: 600000 },
  { level: 5, turnover: 25000000, monthly: 125000, yearly: 1500000 },
  { level: 6, turnover: 70000000, monthly: 350000, yearly: 4200000 },
  { level: 7, turnover: 150000000, monthly: 750000, yearly: 9000000 },
  { level: 8, turnover: 350000000, monthly: 1750000, yearly: 21000000 },
  { level: 9, turnover: 750000000, monthly: 3750000, yearly: 45000000 },
  { level: 10, turnover: 1000000000, monthly: 5000000, yearly: 60000000 }
];

const defaultCMS = {
  hero: {
    title: "Green Future Tech",
    subtitle: "Empowering Your Green Future & Sustaining Tomorrow. Grow your wealth through transparent green energy investments and referral compensation.",
    primaryBtn: "Join Now",
    primaryBtnLink: "/register",
    secondaryBtn: "View Plan",
    secondaryBtnLink: "/business-plan",
  },
  about: {
    heading: "Building a Sustainable Tomorrow",
    description: "Green Future Tech is dedicated to building sustainable investment platforms for everyone. The company invests the collected capital into various channels, primarily stock and forex markets, to distribute profits and ensure long-term stability for our affiliates.",
    vision: "To be the most trusted and reliable service provider of smart saving solutions worldwide.",
    mission: "To provide financial freedom to 1 lakh people by 2030."
  },
  contact: {
    address: "123 Anywhere St., Any City",
    email: "greenfuturetech2.0@gmail.com",
    phone: "+91 2513593428",
    website: "www.Greenfuturetech.net"
  },
  posters: [
    { id: "poster-1", title: "Launch Poster", image: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=800&q=80", category: "offers", status: "Active" },
    { id: "poster-2", title: "Thailand Trip Winner", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80", category: "announcements", status: "Active" },
    { id: "poster-3", title: "Super Car Bonanza", image: "https://images.unsplash.com/photo-1525609004556-c46c7d6cf0a3?auto=format&fit=crop&w=800&q=80", category: "rank", status: "Active" }
  ],
  popup: {
    title: "Special Launch Bonus!",
    message: "Receive 100 GFT signup tokens instantly upon registration! Stake Eco-Tech packages to earn 5x token rewards.",
    active: true
  }
};
...
export function AppProvider({ children }) {
  ...
  const loadDashboardData = async (token) => {
    ...
    try {
      ...
      // Fetch Withdrawals
      try {
        const withdrawalsRes = await fetch(`${API_URL}/wallet/withdrawals`, {
          headers: { Authorization: `Bearer ${token}` }
        });
